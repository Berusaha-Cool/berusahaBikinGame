    ...
    <>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary
          ...
          id="panel1bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to choose your niche ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to identify a problem ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary
          ...
          id="panel3bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to find a solution ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        <AccordionSummary
          ...
          id="panel4bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to validate your idea ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
