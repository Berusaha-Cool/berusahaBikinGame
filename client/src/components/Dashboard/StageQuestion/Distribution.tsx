    ...
    <>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>
            How do you find an audience that buys ?{' '}
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to build an audience ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary
          ...
          id="panel3bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>How to attract client ?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        ...
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>
            How to build a winning launch strategy ?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        ...
        >
          <Typography sx={{ width: '100%', flexShrink: 0 }}>
            How to diversify your acquisition chanels ?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
